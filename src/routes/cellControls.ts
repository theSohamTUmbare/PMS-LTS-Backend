...
router.put('/:id',verifyToken, cellController.updateCell);    // Route to update an existing cell by ID
router.delete('/:id',verifyToken, cellController.deleteCell); // Route to delete a cell by ID
